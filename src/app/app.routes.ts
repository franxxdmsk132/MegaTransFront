...
export const routes: Routes = [
  ...
  {
    path: 'crearDetalleTransporte',
    component: CrearDetalleTransporteComponent,
  },
  {
    path: 'listarDetalleTransporte',
    component: DetalleTransporteListarComponent,
  },
